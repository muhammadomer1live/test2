...
def train_model_gui(model, num_epochs=2):
    ...
    def start_training():
        ...
        # Save the model and vocab
        save_model_and_vocab(model, word_to_idx, idx_to_word)

    start_button = tk.Button(input_frame, text="Start Training", command=start_training)
...
# Example usage
train_model_gui(model, num_epochs=2)
...
plot_example_captions(model, train_dataset, word_to_idx, idx_to_word, num_examples=1)
