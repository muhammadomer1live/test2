...
# Function to plot loss curve after training
...
# Function to report system resources used during training
...
# Function to create and start GUI application
def start_gui():
    global root
    root = tk.Tk()
